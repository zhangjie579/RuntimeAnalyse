...
enum {
    BLOCK_DEALLOCATING =      (0x0001),  // runtime deallocating
...
// 如果__block修饰的是对象, 就需要copy、dispose
struct Block_byref_2 {
    // requires BLOCK_BYREF_HAS_COPY_DISPOSE
    void (*byref_keep)(struct Block_byref *dst, struct Block_byref *src); // copy
    void (*byref_destroy)(struct Block_byref *); // dispose
};
